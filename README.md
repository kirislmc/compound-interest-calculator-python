...
Validates the input (no negative numbers or letters).
Calculates the total balance using the compound interest formula.
Displays the final amount formatted as currency.
